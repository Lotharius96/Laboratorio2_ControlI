// ======================================================================
// Lab2_control.v generated from TopDesign.cysch
// 12/17/2020 at 22:08
...
module top ;
	...
	wire [0:0] tmpOE__giro1_net;
	wire [0:0] tmpFB_0__giro1_net;
	wire [0:0] tmpIO_0__giro1_net;
	wire [0:0] tmpINTERRUPT_0__giro1_net;
	electrical [0:0] tmpSIOVREF__giro1_net;
	...
	cy_psoc3_pins_v1_10
		...
		giro1
		 (.oe(tmpOE__giro1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__giro1_net[0:0]}),
		  .io({tmpIO_0__giro1_net[0:0]}),
		  .siovref(tmpSIOVREF__giro1_net),
		  .interrupt({tmpINTERRUPT_0__giro1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__giro1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__giro2_net;
	wire [0:0] tmpFB_0__giro2_net;
	wire [0:0] tmpIO_0__giro2_net;
	wire [0:0] tmpINTERRUPT_0__giro2_net;
	electrical [0:0] tmpSIOVREF__giro2_net;

	cy_psoc3_pins_v1_10
		#(.id("64e0dd01-fafa-4813-82dc-2a9ed8860ff0"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		giro2
		 (.oe(tmpOE__giro2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__giro2_net[0:0]}),
		  .io({tmpIO_0__giro2_net[0:0]}),
		  .siovref(tmpSIOVREF__giro2_net),
		  .interrupt({tmpINTERRUPT_0__giro2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__giro2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__spwm_net;
	wire [0:0] tmpFB_0__spwm_net;
	wire [0:0] tmpIO_0__spwm_net;
	wire [0:0] tmpINTERRUPT_0__spwm_net;
	electrical [0:0] tmpSIOVREF__spwm_net;

	cy_psoc3_pins_v1_10
		#(.id("32853538-fa58-4665-ba32-35539be6f258"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		spwm
		 (.oe(tmpOE__spwm_net),
		  .y({Net_216}),
		  .fb({tmpFB_0__spwm_net[0:0]}),
		  .io({tmpIO_0__spwm_net[0:0]}),
		  .siovref(tmpSIOVREF__spwm_net),
		  .interrupt({tmpINTERRUPT_0__spwm_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__spwm_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("2b4c1a89-f85b-485f-8a2c-7f6fa3371ebd"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__sensorA_net;
	wire [0:0] tmpFB_0__sensorA_net;
	wire [0:0] tmpIO_0__sensorA_net;
	electrical [0:0] tmpSIOVREF__sensorA_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		sensorA
		 (.oe(tmpOE__sensorA_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__sensorA_net[0:0]}),
		  .io({tmpIO_0__sensorA_net[0:0]}),
		  .siovref(tmpSIOVREF__sensorA_net),
		  .interrupt({Net_242}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__sensorA_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__sensorB_net;
	wire [0:0] tmpFB_0__sensorB_net;
	wire [0:0] tmpIO_0__sensorB_net;
	wire [0:0] tmpINTERRUPT_0__sensorB_net;
	electrical [0:0] tmpSIOVREF__sensorB_net;

	cy_psoc3_pins_v1_10
		#(.id("2051087d-ad64-4a83-b388-15307affacb3"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		sensorB
		 (.oe(tmpOE__sensorB_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__sensorB_net[0:0]}),
		  .io({tmpIO_0__sensorB_net[0:0]}),
		  .siovref(tmpSIOVREF__sensorB_net),
		  .interrupt({tmpINTERRUPT_0__sensorB_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__sensorB_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__signal_Input_net;
	wire [0:0] tmpFB_0__signal_Input_net;
	wire [0:0] tmpIO_0__signal_Input_net;
	wire [0:0] tmpINTERRUPT_0__signal_Input_net;
	electrical [0:0] tmpSIOVREF__signal_Input_net;

	cy_psoc3_pins_v1_10
		#(.id("bb83c271-5fc4-4b69-9e03-c9d9dbae66f7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		signal_Input
		 (.oe(tmpOE__signal_Input_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__signal_Input_net[0:0]}),
		  .analog({Net_245}),
		  .io({tmpIO_0__signal_Input_net[0:0]}),
		  .siovref(tmpSIOVREF__signal_Input_net),
		  .interrupt({tmpINTERRUPT_0__signal_Input_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__signal_Input_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
